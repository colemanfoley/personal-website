...
function backendFunction(){
	// Some global variables for the backend part. These will be used to personalize 
	//feedback on the backend choice and later in the conclusionGenerator to give a recommendation.
...
//This function gives immediate feedback on the user's choice of backend language.
...
function conclusionGenerator(){
	...
	independentRuby = "Michael Hartl's Ruby Tutorial is often recommended."
	...
	else if (learningStyleSelection === "Independent" && backendSelection == "Ruby"){
		document.getElementById('conclusionDummy').innerHTML = independentRuby;
	}
};
